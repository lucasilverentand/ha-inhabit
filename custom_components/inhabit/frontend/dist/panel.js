...
.opening-ghost {
  ...
  `}connectedCallback(){super.connectedCallback(),this._lastFittedFloorId=null,this._cleanupEffects.push(Le(()=>{this._viewBox=Be.value}),Le(()=>{const e=We.value,t=this._canvasMode;this._canvasMode=e,"simulate"===t&&"simulate"!==e&&this.hass&&this.hass.callWS({type:"inhabit/simulate/target/clear"}).catch(()=>{})}),Le(()=>{const e=Fe.value;e&&e.id!==this._lastFittedFloorId&&(this._lastFittedFloorId=e.id,requestAnimationFrame(()=>this._fitToFloor(e)))}),Le(()=>{const e=Ye.value,t=this._focusedRoomId;this._focusedRoomId=e,e?requestAnimationFrame(()=>this._animateToRoom(e)):null!==t&&requestAnimationFrame(()=>this._animateToFloor())})),this._loadHaAreas(),this._resizeObserver=new ResizeObserver(()=>{const e=Fe.value;e&&this._fitToFloor(e)}),this._resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._cancelViewBoxAnimation(),null!==this._swingRaf&&(cancelAnimationFrame(this._swingRaf),this._swingRaf=null),null!==this._blinkTimer&&(clearTimeout(this._blinkTimer),this._blinkTimer=null),this._resizeObserver?.disconnect(),this._cleanupEffects.forEach(e=>e()),this._cleanupEffects=[]}async _loadHaAreas(){if(this.hass)try{const e=await this.hass.callWS({type:"config/area_registry/list"});this._haAreas=e}catch(e){console.error("Error loading HA areas:",e)}}_handleWheel(e){e.preventDefault(),this._cancelViewBoxAnimation();const t=e.deltaY>0?1.1:.9,o=this._screenToSvg({x:e.clientX,y:e.clientY}),i=this._viewBox.width*t,n=this._viewBox.height*t;if(i<100||i>1e4)return;const s={x:o.x-(o.x-this._viewBox.x)*t,y:o.y-(o.y-this._viewBox.y)*t,width:i,height:n};Be.value=s,this._viewBox=s}_handlePointerDown(e){const t=this._screenToSvg({x:e.clientX,y:e.clientY}),o=Re.value,i=this._getSnappedPoint(t,"light"===o||"switch"===o||"mmwave"===o||"wall"===o||"zone"===o),n=this._canvasMode;if(this._pendingDevice&&"light"!==Re.value&&"switch"!==Re.value&&(this._pendingDevice=null),1===e.button)return this._cancelViewBoxAnimation(),this._isPanning=!0,this._panStart={x:e.clientX,y:e.clientY},void this._svg?.setPointerCapture(e.pointerId);if("viewing"===n&&0===e.button){if(this._handleSelectClick(t,e.shiftKey))return;return this._cancelViewBoxAnimation(),this._isPanning=!0,this._panStart={x:e.clientX,y:e.clientY},void this._svg?.setPointerCapture(e.pointerId)}if("simulate"===n&&(0===e.button||2===e.button)){const o=Qe.value,i=this._viewBox,n=.015*Math.max(i.width,i.height),s=o.find(e=>{const o=e.position.x-t.x,i=e.position.y-t.y;return Math.sqrt(o*o+i*i)<n});if(2===e.button&&s)return void this._removeSimulatedTarget(s.id);if(0===e.button)return void(s?(this._draggingSimTarget={targetId:s.id,pointerId:e.pointerId},this._svg?.setPointerCapture(e.pointerId)):this._addSimulatedTarget(t))}if(0===e.button)if("select"===o){const o=!!this._edgeEditor||!!this._multiEdgeEditor;this._edgeEditor=null,this._multiEdgeEditor=null,this._roomEditor=null,this._zoneEditor=null;if(this._handleSelectClick(t,e.shiftKey)){if("zone"===Oe.value.type&&1===Oe.value.ids.length){const o=Fe.value,i=o?.zones?.find(e=>e.id===Oe.value.ids[0]);i?.polygon?.vertices&&(this._draggingZone={zone:i,startPoint:t,originalVertices:i.polygon.vertices.map(e=>({x:e.x,y:e.y})),hasMoved:!1,pointerId:e.pointerId},this._svg?.setPointerCapture(e.pointerId))}else if(("light"===Oe.value.type||"switch"===Oe.value.type||"mmwave"===Oe.value.type)&&1===Oe.value.ids.length){const o=Oe.value.type,i=Oe.value.ids[0];let n=null;n="light"===o?Ve.value.find(e=>e.id===i)?.position??null:"switch"===o?qe.value.find(e=>e.id===i)?.position??null:Je.value.find(e=>e.id===i)?.position??null,n&&(this._draggingPlacement={type:o,id:i,startPoint:t,originalPosition:{...n},hasMoved:!1,pointerId:e.pointerId},this._svg?.setPointerCapture(e.pointerId))}}else o&&(Oe.value={type:"none",ids:[]}),this._isPanning=!0,this._panStart={x:e.clientX,y:e.clientY},this._svg?.setPointerCapture(e.pointerId)}else if("wall"===o){this._edgeEditor=null,this._multiEdgeEditor=null,this._roomEditor=null;const t=this._wallStartPoint&&e.shiftKey?this._cursorPos:i;this._handleWallClick(t,e.shiftKey)}else"light"===o||"switch"===o?(this._edgeEditor=null,this._multiEdgeEditor=null,this._handleDeviceClick(i)):"mmwave"===o?(this._edgeEditor=null,this._multiEdgeEditor=null,this._placeMmwave(i)):"door"===o||"window"===o?this._openingPreview&&(this._edgeEditor=null,this._multiEdgeEditor=null,this._roomEditor=null,this._placeOpening(o)):"zone"===o?(this._edgeEditor=null,this._multiEdgeEditor=null,this._roomEditor=null,this._zoneEditor=null,this._handleZonePolyClick(this._cursorPos)):(this._edgeEditor=null,this._multiEdgeEditor=null,this._roomEditor=null,this._isPanning=!0,this._panStart={x:e.clientX,y:e.clientY},this._svg?.setPointerCapture(e.pointerId))}_handleDeviceClick(e){this._pendingDevice={position:e},this._entitySearch=""}async _placeOpening(e){if(!this.hass||!this._openingPreview)return;const t=Fe.value,o=Ne.value;if(!t||!o)return;const i=this.hass,n=o.id,s=t.id,{edgeId:r,t:a,startPos:l,endPos:d,thickness:c,position:h}=this._openingPreview,p="door"===e?80:100,g=e,u={...l},f={...d},_=c,y={...h};try{const t=await i.callWS({type:"inhabit/edges/split",floor_plan_id:n,floor_id:s,edge_id:r,position:a,new_type:g,width:p,..."door"===e?{opening_parts:"single",opening_type:"swing",swing_direction:"left"}:{opening_parts:"single",opening_type:"swing"}});await ot(),await this._syncRoomsWithEdges();const o=t.edges.map(e=>e.id);Xt({type:"opening_place",description:`Place ${e}`,undo:async()=>{for(const e of o)try{await i.callWS({type:"inhabit/edges/delete",floor_plan_id:n,floor_id:s,edge_id:e})}catch{}await i.callWS({type:"inhabit/edges/add",floor_plan_id:n,floor_id:s,start:u,end:f,thickness:_}),await ot(),await this._syncRoomsWithEdges()},redo:async()=>{const t=Fe.value;if(!t)return;const o=Ot(t).find(e=>{if("wall"!==e.type)return!1;const t=this._getClosestPointOnSegment(y,e.startPos,e.endPos);return Math.sqrt((t.x-y.x)**2+(t.y-y.y)**2)<5});o&&await i.callWS({type:"inhabit/edges/split",floor_plan_id:n,floor_id:s,edge_id:o.id,position:a,new_type:g,width:p,..."door"===e?{opening_parts:"single",opening_type:"swing",swing_direction:"left"}:{opening_parts:"single",opening_type:"swing"}}),await ot(),await this._syncRoomsWithEdges()}})}catch(e){console.error("Error placing opening:",e)}}_handlePointerMove(e){const t=this._screenToSvg({x:e.clientX,y:e.clientY}),o=Re.value;let i=this._getSnappedPoint(t,"light"===o||"switch"===o||"mmwave"===o||"wall"===o||"zone"===o);if(e.shiftKey&&"wall"===o&&this._wallStartPoint){i=Math.abs(i.x-this._wallStartPoint.x)>=Math.abs(i.y-this._wallStartPoint.y)?{x:i.x,y:this._wallStartPoint.y}:{x:this._wallStartPoint.x,y:i.y}}if("zone"===o&&this._zonePolyPoints.length>0){const e=this._zonePolyPoints[this._zonePolyPoints.length-1],t=Math.abs(i.x-e.x),o=Math.abs(i.y-e.y),n=15;o<n&&t>n?i={x:i.x,y:e.y}:t<n&&o>n&&(i={x:e.x,y:i.y})}if(this._cursorPos=i,this._draggingSimTarget)return this._moveSimulatedTargetLocal(this._draggingSimTarget.targetId,t),void this._throttledMoveSimTarget(this._draggingSimTarget.targetId,t);if(this._draggingZone){const e=t.x-this._draggingZone.startPoint.x,o=t.y-this._draggingZone.startPoint.y;if(!this._draggingZone.hasMoved&&(Math.abs(e)>3||Math.abs(o)>3)&&(this._draggingZone.hasMoved=!0),this._draggingZone.hasMoved){const t=this._draggingZone.zone;if(t.polygon?.vertices){const i={x:this._draggingZone.originalVertices[0].x+e,y:this._draggingZone.originalVertices[0].y+o},n=Ze.value?st(i,Ue.value):i,s=n.x-i.x,r=n.y-i.y;for(let i=0;i<t.polygon.vertices.length;i++)t.polygon.vertices[i]={x:this._draggingZone.originalVertices[i].x+e+s,y:this._draggingZone.originalVertices[i].y+o+r}}this.requestUpdate()}return}if(this._draggingPlacement){const e=t.x-this._draggingPlacement.startPoint.x,o=t.y-this._draggingPlacement.startPoint.y;if(!this._draggingPlacement.hasMoved&&(Math.abs(e)>3||Math.abs(o)>3)&&(this._draggingPlacement.hasMoved=!0),this._draggingPlacement.hasMoved){const t={x:this._draggingPlacement.originalPosition.x+e,y:this._draggingPlacement.originalPosition.y+o},i=Ze.value?st(t,Ue.value):t,n=this._draggingPlacement;"light"===n.type?Ve.value=Ve.value.map(e=>e.id===n.id?{...e,position:i}:e):"switch"===n.type?qe.value=qe.value.map(e=>e.id===n.id?{...e,position:i}:e):Je.value=Je.value.map(e=>e.id===n.id?{...e,position:i}:e),this.requestUpdate()}return}if(this._rotatingMmwave)this._handleMmwaveRotationMove(t);else{if(this._draggingZoneVertex){let e=this._getSnappedPoint(t,!0);const o=this._draggingZoneVertex.zone;if(o.polygon?.vertices){const t=o.polygon.vertices,i=this._draggingZoneVertex.vertexIndex,n=t.length,s=t[(i-1+n)%n],r=t[(i+1)%n],a=15;for(const t of[s,r])Math.abs(e.x-t.x)<a&&(e={x:t.x,y:e.y}),Math.abs(e.y-t.y)<a&&(e={x:e.x,y:t.y});t[i]={x:e.x,y:e.y}}return void this.requestUpdate()}if(this._draggingNode){const o=e.clientX-this._draggingNode.startX,i=e.clientY-this._draggingNode.startY;return(Math.abs(o)>3||Math.abs(i)>3)&&(this._draggingNode.hasMoved=!0),this._cursorPos=this._getSnappedPointForNode(t),void this.requestUpdate()}if(this._isPanning){const t=(e.clientX-this._panStart.x)*(this._viewBox.width/this._svg.clientWidth),o=(e.clientY-this._panStart.y)*(this._viewBox.height/this._svg.clientHeight),i={...this._viewBox,x:this._viewBox.x-t,y:this._viewBox.y-o};return this._panStart={x:e.clientX,y:e.clientY},Be.value=i,void(this._viewBox=i)}this._wallStartPoint||"select"!==o||"walls"!==this._canvasMode||this._checkNodeHover(t),"zone"===o&&this._zonePolyPoints.length>0&&this.requestUpdate(),"door"!==o&&"window"!==o||this._updateOpeningPreview(t)}}_checkNodeHover(e){const t=Fe.value;if(!t)return void(this._hoveredNode=null);const o=Ut(e,t.nodes,15);this._hoveredNode=o}_updateOpeningPreview(e){const t=Fe.value;if(!t)return void(this._openingPreview=null);const o=Ot(t);let i=null,n=30,s=e,r=0;for(const t of o){if("wall"!==t.type)continue;const o=this._getClosestPointOnSegment(e,t.startPos,t.endPos),a=Math.sqrt((e.x-o.x)**2+(e.y-o.y)**2);if(a<n){n=a,i=t,s=o;const e=t.endPos.x-t.startPos.x,l=t.endPos.y-t.startPos.y,d=e*e+l*l;r=d>0?((o.x-t.startPos.x)*e+(o.y-t.startPos.y)*l)/d:0}}this._openingPreview=i?{edgeId:i.id,position:s,startPos:i.startPos,endPos:i.endPos,thickness:i.thickness,t:r}:null,this.requestUpdate()}_handlePointerUp(e){if(this._draggingSimTarget){const t=this._screenToSvg({x:e.clientX,y:e.clientY});return this._sendSimTargetMove(this._draggingSimTarget.targetId,t),this._svg?.releasePointerCapture(e.pointerId),this._draggingSimTarget=null,void(this._simMoveThrottle&&(clearTimeout(this._simMoveThrottle),this._simMoveThrottle=null))}if(this._rotatingMmwave)return this._finishMmwaveRotation(),void this._svg?.releasePointerCapture(e.pointerId);if(this._draggingPlacement)return this._draggingPlacement.hasMoved&&this._finishPlacementDrag(),this._svg?.releasePointerCapture(e.pointerId),void(this._draggingPlacement=null);if(this._draggingZone){if(this._draggingZone.hasMoved)this._finishZoneDrag();else if("occupancy"===this._canvasMode){const e=this._draggingZone.zone,t=e.ha_area_id?this._haAreas.find(t=>t.area_id===e.ha_area_id)?.name??e.name:e.name;Xe.value={id:e.id,name:t,type:"zone"}}else{const e=this._draggingZone.zone;this._zoneEditor={zone:e,editName:e.name,editColor:e.color,editAreaId:e.ha_area_id??null}}return this._svg?.releasePointerCapture(e.pointerId),void(this._draggingZone=null)}return this._draggingZoneVertex?(this._finishZoneVertexDrag(),this._svg?.releasePointerCapture(e.pointerId),void(this._draggingZoneVertex=null)):this._draggingNode?(this._draggingNode.hasMoved?this._finishNodeDrag():this._startWallFromNode(),void this._svg?.releasePointerCapture(e.pointerId)):void(this._isPanning&&(this._isPanning=!1,this._svg?.releasePointerCapture(e.pointerId)))}async _handleDblClick(e){if("walls"!==this._canvasMode)return;const t=this._screenToSvg({x:e.clientX,y:e.clientY}),o=Fe.value,i=Ne.value;if(!o||!i||!this.hass)return;const n=Ut(t,o.nodes,15);if(n)return this._nodeEditor={node:n,editX:Math.round(n.x).toString(),editY:Math.round(n.y).toString()},this._edgeEditor=null,void(this._multiEdgeEditor=null);const s=Ot(o);for(const e of s){if(this._pointToSegmentDistance(t,e.startPos,e.endPos)<e.thickness/2+8){try{await this.hass.callWS({type:"inhabit/edges/split_at_point",floor_plan_id:i.id,floor_id:o.id,edge_id:e.id,point:{x:t.x,y:t.y}}),await ot(),await this._syncRoomsWithEdges()}catch(e){console.error("Failed to split edge:",e)}return}}}async _handleContextMenu(e){if("simulate"===this._canvasMode)return void e.preventDefault();if("walls"!==this._canvasMode)return;e.preventDefault();const t=this._screenToSvg({x:e.clientX,y:e.clientY}),o=Fe.value,i=Ne.value;if(!o||!i||!this.hass)return;const n=Ut(t,o.nodes,15);if(!n)return;if(2===Bt(n.id,o.edges).length)try{await this.hass.callWS({type:"inhabit/nodes/dissolve",floor_plan_id:i.id,floor_id:o.id,node_id:n.id}),await ot(),await this._syncRoomsWithEdges(),this._hoveredNode=null,Oe.value={type:"none",ids:[]},this._edgeEditor=null}catch(e){console.error("Failed to dissolve node:",e)}}_startWallFromNode(){this._draggingNode&&(this._wallStartPoint=this._draggingNode.originalCoords,Re.value="wall",this._draggingNode=null,this._hoveredNode=null)}async _finishNodeDrag(){if(!this._draggingNode||!this.hass)return void(this._draggingNode=null);const e=Fe.value,t=Ne.value;if(!e||!t)return void(this._draggingNode=null);const o=this._cursorPos,i=this._draggingNode.originalCoords;if(Math.abs(o.x-i.x)<1&&Math.abs(o.y-i.y)<1)return void(this._draggingNode=null);const n=At(xt(e.nodes,e.edges),this._draggingNode.node.id,o.x,o.y);if(n.blocked)return n.blockedBy&&this._blinkEdges(n.blockedBy),void(this._draggingNode=null);if(0!==n.updates.length){try{await this._withNodeUndo(n.updates,"Move node",async()=>{await this.hass.callWS({type:"inhabit/nodes/update",floor_plan_id:t.id,floor_id:e.id,updates:n.updates.map(e=>({node_id:e.nodeId,x:e.x,y:e.y}))}),await ot()})}catch(e){console.error("Error updating node:",e),alert(`Failed to update node: ${e}`)}this._draggingNode=null,await this._removeDegenerateEdges()}else this._draggingNode=null}async _removeDegenerateEdges(){if(!this.hass)return;const e=Fe.value,t=Ne.value;if(!e||!t)return;const o=function(e,t,o=.5){const i=new Map;for(const t of e)i.set(t.id,t);const n=[];for(const e of t){const t=i.get(e.start_node),s=i.get(e.end_node);t&&s&&nt(t,s)<=o&&n.push(e.id)}return n}(e.nodes,e.edges);if(0!==o.length){console.log("%c[degenerate]%c Removing %d zero-length edge(s): %s","color:#f59e0b;font-weight:bold","",o.length,o.map(e=>e.slice(0,8)+"…").join(", "));try{for(const i of o)await this.hass.callWS({type:"inhabit/edges/delete",floor_plan_id:t.id,floor_id:e.id,edge_id:i});await ot(),await this._syncRoomsWithEdges()}catch(e){console.error("Error removing degenerate edges:",e)}}}_handleKeyDown(e){if("Escape"===e.key){if(this._wallStartPoint=null,this._wallChainStart=null,this._hoveredNode=null,this._draggingNode=null,this._draggingZone=null,this._draggingZoneVertex=null,this._draggingPlacement=null,this._rotatingMmwave){const e=this._rotatingMmwave;Je.value=Je.value.map(t=>t.id===e.id?{...t,angle:e.originalAngle}:t),this._rotatingMmwave=null}this._pendingDevice=null,this._edgeEditor=null,this._multiEdgeEditor=null,this._nodeEditor=null,this._roomEditor=null,this._zoneEditor=null,this._zonePolyPoints=[],this._pendingZonePolygon=null,Oe.value={type:"none",ids:[]},Ge.value=null,Re.value="select"}else"Backspace"!==e.key&&"Delete"!==e.key||!this._zoneEditor?"Backspace"!==e.key&&"Delete"!==e.key||!this._multiEdgeEditor?"Backspace"!==e.key&&"Delete"!==e.key||!this._edgeEditor?"Backspace"!==e.key&&"Delete"!==e.key||"light"!==Oe.value.type&&"switch"!==Oe.value.type&&"mmwave"!==Oe.value.type?"r"===e.key&&"mmwave"===Oe.value.type?(e.preventDefault(),this._rotateMmwave(e.shiftKey?-15:15)):"z"!==e.key||!e.ctrlKey&&!e.metaKey||e.shiftKey?("z"===e.key&&(e.ctrlKey||e.metaKey)&&e.shiftKey||"y"===e.key&&(e.ctrlKey||e.metaKey))&&(e.preventDefault(),Jt()):(e.preventDefault(),Gt()):(e.preventDefault(),this._deleteSelectedPlacement()):(e.preventDefault(),this._handleEdgeDelete()):(e.preventDefault(),this._handleMultiEdgeDelete()):(e.preventDefault(),this._handleZoneDelete())}async _handleEditorSave(){if(!this._edgeEditor||!this.hass)return;const e=Fe.value,t=Ne.value;if(!e||!t)return;const o=this._edgeEditor.edge,i=parseFloat(this._editingLength);if(isNaN(i)||i<=0)return;const n=Math.abs(i-this._edgeEditor.length)>=.01,s=this._editingDirection!==o.direction,r=this._editingLengthLocked!==o.length_locked,a="door"===o.type||"window"===o.type,l=a&&this._editingOpeningParts!==(o.opening_parts??"single"),d=a&&this._editingOpeningType!==(o.opening_type??"swing"),c=a&&this._editingSwingDirection!==(o.swing_direction??"left"),h=a&&(this._editingEntityId??null)!==(o.entity_id??null),p=s||r||l||d||c||h;try{if(s){if(!await this._applyDirection(o,this._editingDirection))return}if(n&&await this._updateEdgeLength(o,i),p){const i=Fe.value;if(i&&r){const e={};s&&(e.direction=this._editingDirection),r&&(e.length_locked=this._editingLengthLocked);const t=function(e,t,o,i){if(ht){const e=Object.entries(i).map(([e,t])=>`${e}=${t}`).join(", ");console.group(pt+" checkConstraintsFeasible: %cedge %s → {%s}",gt,ut,o.slice(0,8)+"…",e)}const n=xt(e,t),s=wt(n),{magnitudes:r}=Et(n,s),a=t.map(e=>e.id!==o?e:{...e,...void 0!==i.direction&&{direction:i.direction},...void 0!==i.length_locked&&{length_locked:i.length_locked},...void 0!==i.angle_group&&{angle_group:i.angle_group??void 0}}),l=xt(e,a),d=wt(l),c=new Set;for(const[e,t]of l.nodes)t.pinned&&c.add(e);const h=Pt(l,c,d,r);return h.blocked?(ht&&(console.log(pt+" %c→ NOT FEASIBLE%c — blocked by: %s",gt,ft,"",(h.blockedBy||[]).map(e=>{const t=l.edges.get(e);return t?vt(t,l.nodes):e.slice(0,8)+"…"}).join(" | ")),console.groupEnd()),{feasible:!1,blockedBy:h.blockedBy}):(ht&&(console.log(pt+" %c→ Feasible",gt,_t),console.groupEnd()),{feasible:!0})}(i.nodes,i.edges,o.id,e);if(!t.feasible)return void(t.blockedBy&&this._blinkEdges(t.blockedBy))}const n={type:"inhabit/edges/update",floor_plan_id:t.id,floor_id:e.id,edge_id:o.id};s&&(n.direction=this._editingDirection),r&&(n.length_locked=this._editingLengthLocked),l&&(n.opening_parts=this._editingOpeningParts),d&&(n.opening_type=this._editingOpeningType),c&&(n.swing_direction=this._editingSwingDirection),h&&(n.entity_id=this._editingEntityId||null),await this.hass.callWS(n),await ot()}}catch(e){console.error("Error applying edge changes:",e)}this._edgeEditor=null,Oe.value={type:"none",ids:[]}}_handleEditorCancel(){this._edgeEditor=null,Oe.value={type:"none",ids:[]}}async _setDoorOpensToSide(e,t){if(!this.hass)return;if("a"===e)return;const o=Fe.value,i=Ne.value;if(!o||!i)return;const n=this._editingSwingDirection,s={left:"right",right:"left"}[n]??n;try{await this.hass.callWS({type:"inhabit/edges/update",floor_plan_id:i.id,floor_id:o.id,edge_id:t.id,swap_nodes:!0,swing_direction:s}),this._editingSwingDirection=s,await ot();const e=Fe.value;if(e){const o=e.edges.find(e=>e.id===t.id);o&&this._updateEdgeEditorForSelection([o.id])}}catch(e){console.error("Error flipping door side:",e)}}async _handleEdgeDelete(){if(!this._edgeEditor||!this.hass)return;const e=Fe.value,t=Ne.value;if(!e||!t)return;const o=this.hass,i=t.id,n=e.id,s=this._edgeEditor.edge,r=Wt(e.nodes),a=r.get(s.start_node),l=r.get(s.end_node),d={start:a?{x:a.x,y:a.y}:{x:0,y:0},end:l?{x:l.x,y:l.y}:{x:0,y:0},thickness:s.thickness,is_exterior:s.is_exterior,length_locked:s.length_locked,direction:s.direction},c={id:s.id};try{await o.callWS({type:"inhabit/edges/delete",floor_plan_id:i,floor_id:n,edge_id:c.id}),await ot(),await this._syncRoomsWithEdges(),Xt({type:"edge_delete",description:"Delete edge",undo:async()=>{const e=await o.callWS({type:"inhabit/edges/add",floor_plan_id:i,floor_id:n,...d});c.id=e.edge.id,await ot(),await this._syncRoomsWithEdges()},redo:async()=>{await o.callWS({type:"inhabit/edges/delete",floor_plan_id:i,floor_id:n,edge_id:c.id}),await ot(),await this._syncRoomsWithEdges()}})}catch(e){console.error("Error deleting edge:",e)}this._edgeEditor=null,Oe.value={type:"none",ids:[]}}_handleEditorKeyDown(e){"Enter"===e.key?this._handleEditorSave():"Escape"===e.key&&this._handleEditorCancel()}async _withNodeUndo(e,t,o){if(!this.hass)return;const i=Fe.value,n=Ne.value;if(!i||!n)return;const s=this.hass,r=n.id,a=i.id,l=new Map;for(const t of e){const e=i.nodes.find(e=>e.id===t.nodeId);e&&l.set(e.id,{x:e.x,y:e.y})}await o(),await this._syncRoomsWithEdges();const d=Fe.value;if(!d)return;const c=new Map;for(const t of e){const e=d.nodes.find(e=>e.id===t.nodeId);e&&c.set(e.id,{x:e.x,y:e.y})}const h=async e=>{const t=Array.from(e.entries()).map(([e,t])=>({node_id:e,x:t.x,y:t.y}));t.length>0&&await s.callWS({type:"inhabit/nodes/update",floor_plan_id:r,floor_id:a,updates:t}),await ot(),await this._syncRoomsWithEdges()};Xt({type:"node_update",description:t,undo:()=>h(l),redo:()=>h(c)})}async _updateEdgeLength(e,t){if(!this.hass)return;const o=Fe.value,i=Ne.value;if(!o||!i)return;const n=o.edges.map(t=>t.id===e.id?{...t,length_locked:!1}:t),s=Dt(xt(o.nodes,n),e.id,t);if(s.blocked)s.blockedBy&&this._blinkEdges(s.blockedBy);else if(0!==s.updates.length){try{await this._withNodeUndo(s.updates,"Change edge length",async()=>{await this.hass.callWS({type:"inhabit/nodes/update",floor_plan_id:i.id,floor_id:o.id,updates:s.updates.map(e=>({node_id:e.nodeId,x:e.x,y:e.y}))}),await ot()})}catch(e){console.error("Error updating edge length:",e),alert(`Failed to update edge: ${e}`)}await this._removeDegenerateEdges()}}_getSnappedPointForNode(e){const t=Fe.value;if(t){const o=this._draggingNode?.node.id,i=Ut(e,o?t.nodes.filter(e=>e.id!==o):t.nodes,15);if(i)return{x:i.x,y:i.y};if(o){const i=new Set(Bt(o,t.edges).map(e=>`${e.start_node}-${e.end_node}`)),n=Ot(t);let s=null,r=15;for(const t of n){const o=`${t.start_node}-${t.end_node}`;if(i.has(o))continue;const n=this._getClosestPointOnSegment(e,t.startPos,t.endPos),a=Math.sqrt((e.x-n.x)**2+(e.y-n.y)**2);a<r&&(r=a,s=n)}if(s)return s}}return{x:Math.round(e.x),y:Math.round(e.y)}}_getSnappedPoint(e,t=!1){const o=Fe.value;if(!o)return Ze.value?st(e,Ue.value):e;const i=Ut(e,o.nodes,15);if(i)return{x:i.x,y:i.y};if(t){const t=Ot(o);let i=null,n=15;for(const o of t){const t=this._getClosestPointOnSegment(e,o.startPos,o.endPos),s=Math.sqrt(Math.pow(e.x-t.x,2)+Math.pow(e.y-t.y,2));s<n&&(n=s,i=t)}if(i)return i}return Ze.value?st(e,Ue.value):e}_getClosestPointOnSegment(e,t,o){const i=o.x-t.x,n=o.y-t.y,s=i*i+n*n;if(0===s)return t;const r=Math.max(0,Math.min(1,((e.x-t.x)*i+(e.y-t.y)*n)/s));return{x:t.x+r*i,y:t.y+r*n}}_handleSelectClick(e,t=!1){const o=Fe.value;if(!o)return!1;const i=this._canvasMode;if("walls"===i){const i=Ot(o);for(const o of i){if(this._pointToSegmentDistance(e,o.startPos,o.endPos)<o.thickness/2+5){if(t&&"edge"===Oe.value.type){const e=[...Oe.value.ids],t=e.indexOf(o.id);return t>=0?e.splice(t,1):e.push(o.id),Oe.value={type:"edge",ids:e},this._updateEdgeEditorForSelection(e),!0}return Oe.value={type:"edge",ids:[o.id]},this._updateEdgeEditorForSelection([o.id]),!0}}}if("placement"===i||"viewing"===i){for(const t of Ve.value.filter(e=>e.floor_id===o.id)){if(Math.hypot(e.x-t.position.x,e.y-t.position.y)<15)return Oe.value={type:"light",ids:[t.id]},"placement"===i?Ge.value={id:t.id,type:"light"}:this._openEntityDetails(t.entity_id),!0}for(const t of qe.value.filter(e=>e.floor_id===o.id)){if(Math.hypot(e.x-t.position.x,e.y-t.position.y)<15)return Oe.value={type:"switch",ids:[t.id]},"placement"===i?Ge.value={id:t.id,type:"switch"}:this._openEntityDetails(t.entity_id),!0}for(const t of Je.value.filter(e=>e.floor_id===o.id)){if(Math.hypot(e.x-t.position.x,e.y-t.position.y)<15)return Oe.value={type:"mmwave",ids:[t.id]},"placement"===i?Ge.value={id:t.id,type:"mmwave"}:t.entity_id&&this._openEntityDetails(t.entity_id),!0}}if(("furniture"===i||"occupancy"===i)&&o.zones){const t=[...o.zones];for(const o of t)if(o.polygon?.vertices&&this._pointInPolygon(e,o.polygon.vertices)){if("occupancy"===i){Oe.value={type:"zone",ids:[o.id]};const e=o.ha_area_id?this._haAreas.find(e=>e.area_id===o.ha_area_id)?.name??o.name:o.name;return Xe.value={id:o.id,name:e,type:"zone"},!0}return Oe.value={type:"zone",ids:[o.id]},!0}}if("walls"===i||"occupancy"===i)for(const t of o.rooms)if(this._pointInPolygon(e,t.polygon.vertices)){Oe.value={type:"room",ids:[t.id]};const e=t.ha_area_id?this._haAreas.find(e=>e.area_id===t.ha_area_id)?.name??t.name:t.name;return"occupancy"===i?Xe.value={id:t.id,name:e,type:"room"}:this._roomEditor={room:t,editName:e,editColor:t.color,editAreaId:t.ha_area_id??null},!0}return Oe.value={type:"none",ids:[]},Ge.value=null,!1}_updateEdgeEditorForSelection(e){const t=Fe.value;if(!t)return;if(0===e.length)return this._edgeEditor=null,void(this._multiEdgeEditor=null);const o=Wt(t.nodes);if(1===e.length){const i=t.edges.find(t=>t.id===e[0]);if(i){const e=o.get(i.start_node),t=o.get(i.end_node);if(e&&t){const o=this._calculateWallLength(e,t);this._edgeEditor={edge:i,position:{x:(e.x+t.x)/2,y:(e.y+t.y)/2},length:o},this._editingLength=Math.round(o).toString(),this._editingLengthLocked=i.length_locked,this._editingDirection=i.direction,this._editingOpeningParts=i.opening_parts??"single",this._editingOpeningType=i.opening_type??"swing",this._editingSwingDirection=i.swing_direction??"left",this._editingEntityId=i.entity_id??null,this._openingSensorSearch="",this._openingSensorPickerOpen=!1}}return void(this._multiEdgeEditor=null)}const i=e.map(e=>t.edges.find(t=>t.id===e)).filter(e=>!!e),n=[];for(const e of i){const t=o.get(e.start_node),i=o.get(e.end_node);t&&n.push({x:t.x,y:t.y}),i&&n.push({x:i.x,y:i.y})}const s=function(e,t=2){if(e.length<2)return!0;if(2===e.length)return!0;let o=0,i=e[0],n=e[1];for(let t=0;t<e.length;t++)for(let s=t+1;s<e.length;s++){const r=nt(e[t],e[s]);r>o&&(o=r,i=e[t],n=e[s])}if(o<1e-9)return!0;const s=n.x-i.x,r=n.y-i.y,a=Math.sqrt(s*s+r*r);for(const o of e)if(Math.abs((o.x-i.x)*r-(o.y-i.y)*s)/a>t)return!1;return!0}(n);let r;if(s){r=0;for(const e of i){const t=o.get(e.start_node),i=o.get(e.end_node);t&&i&&(r+=this._calculateWallLength(t,i))}this._editingTotalLength=Math.round(r).toString()}this._multiEdgeEditor={edges:i,collinear:s,totalLength:r},this._edgeEditor=null}_pointToSegmentDistance(e,t,o){const i=o.x-t.x,n=o.y-t.y,s=i*i+n*n;if(0===s)return Math.sqrt(Math.pow(e.x-t.x,2)+Math.pow(e.y-t.y,2));const r=Math.max(0,Math.min(1,((e.x-t.x)*i+(e.y-t.y)*n)/s)),a=t.x+r*i,l=t.y+r*n;return Math.sqrt(Math.pow(e.x-a,2)+Math.pow(e.y-l,2))}_handleWallClick(e,t=!1){if(this._wallStartPoint){let o="free";if(t){o=Math.abs(e.x-this._wallStartPoint.x)>=Math.abs(e.y-this._wallStartPoint.y)?"horizontal":"vertical"}this._completeWall(this._wallStartPoint,e,o);const i=Fe.value,n=i?.nodes.some(t=>Math.abs(e.x-t.x)<1&&Math.abs(e.y-t.y)<1);this._wallChainStart&&Math.abs(e.x-this._wallChainStart.x)<1&&Math.abs(e.y-this._wallChainStart.y)<1?(this._wallStartPoint=null,this._wallChainStart=null,Re.value="select"):n?(this._wallStartPoint=null,this._wallChainStart=null):this._wallStartPoint=e}else this._wallStartPoint=e,this._wallChainStart=e}async _completeWall(e,t,o="free"){if(!this.hass)return;const i=Fe.value,n=Ne.value;if(!i||!n)return;const s=this.hass,r=n.id,a=i.id,l={id:""};try{const i=await s.callWS({type:"inhabit/edges/add",floor_plan_id:r,floor_id:a,start:e,end:t,thickness:6,direction:o});l.id=i.edge.id,await ot(),await this._syncRoomsWithEdges(),Xt({type:"edge_add",description:"Add wall",undo:async()=>{await s.callWS({type:"inhabit/edges/delete",floor_plan_id:r,floor_id:a,edge_id:l.id}),await ot(),await this._syncRoomsWithEdges()},redo:async()=>{const i=await s.callWS({type:"inhabit/edges/add",floor_plan_id:r,floor_id:a,start:e,end:t,thickness:6,direction:o});l.id=i.edge.id,await ot(),await this._syncRoomsWithEdges()}})}catch(e){console.error("Error creating edge:",e)}}_screenToSvg(e){if(!this._svg)return e;const t=this._svg.getScreenCTM();if(t){const o=t.inverse();return{x:o.a*e.x+o.c*e.y+o.e,y:o.b*e.x+o.d*e.y+o.f}}const o=this._svg.getBoundingClientRect(),i=this._viewBox.width/o.width,n=this._viewBox.height/o.height;return{x:this._viewBox.x+(e.x-o.left)*i,y:this._viewBox.y+(e.y-o.top)*n}}_cancelViewBoxAnimation(){null!==this._viewBoxAnimation&&(cancelAnimationFrame(this._viewBoxAnimation),this._viewBoxAnimation=null)}_animateToRoom(e){const t=Fe.value;if(!t)return;const o=t.rooms.find(t=>t.id===e);if(!o||0===o.polygon.vertices.length)return;const i=o.polygon.vertices.map(e=>e.x),n=o.polygon.vertices.map(e=>e.y),s=Math.min(...i),r=Math.max(...i),a=Math.min(...n),l=Math.max(...n),d=r-s,c=l-a;let h=d+2*(.15*Math.max(d,50)),p=c+2*(.15*Math.max(c,50));const g=this._svg?.getBoundingClientRect(),u=g&&g.width>0&&g.height>0?g.width/g.height:1.25;h/p>u?p=h/u:h=p*u;const f=(s+r)/2,_=(a+l)/2;this._animateViewBox({x:f-h/2,y:_-p/2,width:h,height:p},400)}_animateToFloor(){const e=Fe.value;if(!e)return;const t=[],o=[];for(const i of e.nodes)t.push(i.x),o.push(i.y);for(const i of e.rooms)for(const e of i.polygon.vertices)t.push(e.x),o.push(e.y);for(const i of Ve.value)i.floor_id===e.id&&(t.push(i.position.x),o.push(i.position.y));for(const i of qe.value)i.floor_id===e.id&&(t.push(i.position.x),o.push(i.position.y));for(const i of Je.value)i.floor_id===e.id&&(t.push(i.position.x),o.push(i.position.y));if(0===t.length)return;const i=Math.min(...t),n=Math.max(...t),s=Math.min(...o),r=Math.max(...o),a=n-i,l=r-s;let d=a+2*(.1*Math.max(a,50)),c=l+2*(.1*Math.max(l,50));const h=this._svg?.getBoundingClientRect(),p=h&&h.width>0&&h.height>0?h.width/h.height:1.25;d/c>p?c=d/p:d=c*p;const g=(i+n)/2,u=(s+r)/2;this._animateViewBox({x:g-d/2,y:u-c/2,width:d,height:c},400)}_animateViewBox(e,t){this._cancelViewBoxAnimation();const o={...this._viewBox},i=performance.now(),n=s=>{const r=s-i,a=Math.min(r/t,1),l=1-Math.pow(1-a,3),d={x:o.x+(e.x-o.x)*l,y:o.y+(e.y-o.y)*l,width:o.width+(e.width-o.width)*l,height:o.height+(e.height-o.height)*l};this._viewBox=d,Be.value=d,this._viewBoxAnimation=a<1?requestAnimationFrame(n):null};this._viewBoxAnimation=requestAnimationFrame(n)}_fitToFloor(e){const t=[],o=[];for(const i of e.nodes)t.push(i.x),o.push(i.y);for(const i of e.rooms)for(const e of i.polygon.vertices)t.push(e.x),o.push(e.y);for(const i of Ve.value)i.floor_id===e.id&&(t.push(i.position.x),o.push(i.position.y));for(const i of qe.value)i.floor_id===e.id&&(t.push(i.position.x),o.push(i.position.y));for(const i of Je.value)i.floor_id===e.id&&(t.push(i.position.x),o.push(i.position.y));if(0===t.length)return;const i=Math.min(...t),n=Math.max(...t),s=Math.min(...o),r=Math.max(...o),a=n-i,l=r-s,d=this._svg?.getBoundingClientRect(),c=d&&d.width>0&&d.height>0?d.width/d.height:1.25;let h=a+2*(.1*Math.max(a,50)),p=l+2*(.1*Math.max(l,50));h/p>c?p=h/c:h=p*c;const g={x:(i+n)/2-h/2,y:(s+r)/2-p/2,width:h,height:p};Be.value=g,this._viewBox=g}async _addSimulatedTarget(e){if(!this.hass)return;const t=Ne.value,o=Fe.value;if(t&&o)try{const i=await this.hass.callWS({type:"inhabit/simulate/target/add",floor_plan_id:t.id,floor_id:o.id,position:{x:e.x,y:e.y},hitbox:et.value});Qe.value=[...Qe.value,i]}catch(e){console.error("Failed to add simulated target:",e)}}async _removeSimulatedTarget(e){if(this.hass)try{await this.hass.callWS({type:"inhabit/simulate/target/remove",target_id:e}),Qe.value=Qe.value.filter(t=>t.id!==e)}catch(e){console.error("Failed to remove simulated target:",e)}}_moveSimulatedTargetLocal(e,t){const o=Fe.value,i=Qe.value,n=i.findIndex(t=>t.id===e);if(-1===n)return;const s=et.value&&o?this._getRegionAtPoint(t,o):null,r={...i[n],position:{x:t.x,y:t.y},region_id:s?.id??null,region_name:s?.name??null},a=[...i];a[n]=r,Qe.value=a}_throttledMoveSimTarget(e,t){this._simMoveThrottle||(this._simMoveThrottle=setTimeout(()=>{this._simMoveThrottle=null,this._sendSimTargetMove(e,t)},66))}async _sendSimTargetMove(e,t){if(this.hass)try{const o=await this.hass.callWS({type:"inhabit/simulate/target/move",target_id:e,position:{x:t.x,y:t.y},hitbox:et.value}),i=Qe.value,n=i.findIndex(t=>t.id===e);if(-1!==n){const e=[...i];e[n]=o,Qe.value=e}}catch{}}_getRegionAtPoint(e,t){if(t.zones)for(const o of t.zones)if(o.polygon?.vertices&&this._pointInPolygon(e,o.polygon.vertices))return{id:o.id,name:o.name};for(const o of t.rooms)if(o.polygon?.vertices&&this._pointInPolygon(e,o.polygon.vertices))return{id:o.id,name:o.name};return null}_renderSimulationLayer(e){const t=Qe.value,o=et.value,i=new Set;if(o)for(const e of t)e.region_id&&i.add(e.region_id);const n=this._viewBox,s=Math.max(n.width,n.height)/100,r=1.2*s,a=1.4*s,l=r+.6*a;return j`
    ...
    `:null}_renderFurnitureDrawingPreview(){if("zone"===Re.value&&this._zonePolyPoints.length>0){const e=this._zonePolyPoints,t=this._cursorPos;let o=`M ${e[0].x} ${e[0].y}`;for(let t=1;t<e.length;t++)o+=` L ${e[t].x} ${e[t].y}`;o+=` L ${t.x} ${t.y}`;let i=null;if(e.length>=3){const o=e[0];Math.sqrt((t.x-o.x)**2+(t.y-o.y)**2)<15&&(i=j`<circle cx="${o.x}" cy="${o.y}" r="8" fill="rgba(76, 175, 80, 0.3)" stroke="#4caf50" stroke-width="2"/>`)}return j`
      ...
      `}return null}_renderZoneEditor(){if(!this._zoneEditor)return null;return H`
      <div class="wall-editor"
           @click=${e=>e.stopPropagation()}
           @pointerdown=${e=>e.stopPropagation()}>
        <div class="wall-editor-header">
...
function(e){return(t,o,i)=>((e,t,o)=>(o.configurable=!0,o.enumerable=!0,Reflect.decorate&&"object"!=typeof t&&Object.defineProperty(e,t,o),o))(t,o,{get(){return(t=>t.renderRoot?.querySelector(e)??null)(this)}})}("svg")],no.prototype,"_svg",void 0),e([ge()],no.prototype,"_viewBox",void 0),e([ge()],no.prototype,"_isPanning",void 0),e([ge()],no.prototype,"_panStart",void 0),e([ge()],no.prototype,"_cursorPos",void 0),e([ge()],no.prototype,"_wallStartPoint",void 0),e([ge()],no.prototype,"_roomEditor",void 0),e([ge()],no.prototype,"_haAreas",void 0),e([ge()],no.prototype,"_hoveredNode",void 0),e([ge()],no.prototype,"_draggingNode",void 0),e([ge()],no.prototype,"_nodeEditor",void 0),e([ge()],no.prototype,"_edgeEditor",void 0),e([ge()],no.prototype,"_multiEdgeEditor",void 0),e([ge()],no.prototype,"_editingTotalLength",void 0),e([ge()],no.prototype,"_editingLength",void 0),e([ge()],no.prototype,"_editingLengthLocked",void 0),e([ge()],no.prototype,"_editingDirection",void 0),e([ge()],no.prototype,"_editingOpeningParts",void 0),e([ge()],no.prototype,"_editingOpeningType",void 0),e([ge()],no.prototype,"_editingSwingDirection",void 0),e([ge()],no.prototype,"_editingEntityId",void 0),e([ge()],no.prototype,"_openingSensorSearch",void 0),e([ge()],no.prototype,"_openingSensorPickerOpen",void 0),e([ge()],no.prototype,"_blinkingEdgeIds",void 0),e([ge()],no.prototype,"_focusedRoomId",void 0),e([ge()],no.prototype,"_pendingDevice",void 0),e([ge()],no.prototype,"_entitySearch",void 0),e([ge()],no.prototype,"_openingPreview",void 0),e([ge(),ge()],no.prototype,"_zonePolyPoints",void 0),e([ge()],no.prototype,"_pendingZonePolygon",void 0),e([ge()],no.prototype,"_zoneEditor",void 0),e([ge()],no.prototype,"_draggingZone",void 0),e([ge()],no.prototype,"_draggingZoneVertex",void 0),e([ge()],no.prototype,"_draggingPlacement",void 0),e([ge()],no.prototype,"_rotatingMmwave",void 0),e([ge()],no.prototype,"_draggingSimTarget",void 0),e([ge()],no.prototype,"_canvasMode",void 0),customElements.get("fpb-canvas")||customElements.define("fpb-canvas",no);const so=[{id:"wall",icon:"mdi:wall",label:"Wall"},{id:"door",icon:"mdi:door",label:"Door"},{id:"window",icon:"mdi:window-closed-variant",label:"Window"}],ro=[{id:"zone",icon:"mdi:vector-polygon",label:"Zone"}],ao=[{id:"light",icon:"mdi:lightbulb",label:"Light"},{id:"switch",icon:"mdi:toggle-switch",label:"Switch"},{id:"mmwave",icon:"mdi:access-point",label:"mmWave"}];class lo extends le{constructor(){super(...arguments),this.floorPlans=[],this._addMenuOpen=!1,this._floorMenuOpen=!1,this._canvasMode="walls",this._renamingFloorId=null,this._renameValue="",this._cleanupEffects=[],this._handleDocumentClick=e=>{e.composedPath().includes(this)||this._closeMenus()}}static{this.styles=r`
  ...
  `}_selectFloor(e){this._floorMenuOpen=!1,this.dispatchEvent(new CustomEvent("floor-select",{detail:{id:e},bubbles:!0,composed:!0}))}_handleToolSelect(e){Re.value=e,this._addMenuOpen=!1}_handleUndo(){Gt()}_handleRedo(){Jt()}_handleAddFloor(){this._floorMenuOpen=!1,this.dispatchEvent(new CustomEvent("add-floor",{bubbles:!0,composed:!0}))}_handleDeleteFloor(e,t,o){e.stopPropagation(),confirm(`Delete "${o}"? This will remove all walls, rooms, and devices on this floor.`)&&(this._floorMenuOpen=!1,this.dispatchEvent(new CustomEvent("delete-floor",{detail:{id:t},bubbles:!0,composed:!0})))}_startRename(e,t,o){e.stopPropagation(),this._renamingFloorId=t,this._renameValue=o,this.updateComplete.then(()=>{const e=this.shadowRoot?.querySelector(".rename-input");e&&(e.focus(),e.select())})}_commitRename(){const e=this._renamingFloorId,t=this._renameValue.trim();this._renamingFloorId=null,e&&t&&this.dispatchEvent(new CustomEvent("rename-floor",{detail:{id:e,name:t},bubbles:!0,composed:!0}))}_cancelRename(){this._renamingFloorId=null}_handleRenameKeyDown(e){"Enter"===e.key?this._commitRename():"Escape"===e.key&&this._cancelRename()}_openImportExport(){this._floorMenuOpen=!1,this.dispatchEvent(new CustomEvent("open-import-export",{bubbles:!0,composed:!0}))}_toggleAddMenu(){this._addMenuOpen=!this._addMenuOpen,this._floorMenuOpen=!1}_toggleFloorMenu(){this._floorMenuOpen=!this._floorMenuOpen,this._addMenuOpen=!1}_closeMenus(){this._addMenuOpen=!1,this._floorMenuOpen=!1}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._handleDocumentClick),this._cleanupEffects.push(Le(()=>{this._canvasMode=We.value}))}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._handleDocumentClick),this._cleanupEffects.forEach(e=>e()),this._cleanupEffects=[]}render(){const e=Ne.value,t=Fe.value,o=Re.value,i=this._canvasMode,n=e?.floors||[],s="walls"===i?so:"furniture"===i?ro:"placement"===i?ao:[];return H`
      ...
      <div class="mode-group">
        ...
        <button
          class="mode-button ${"simulate"===i?"active":""}"
          @click=${()=>tt("simulate")}
          title="Simulate mode"
        >
      ...
      `:null}
    `}}e([pe({attribute:!1})],lo.prototype,"hass",void 0),e([pe({attribute:!1})],lo.prototype,"floorPlans",void 0),e([ge()],lo.prototype,"_addMenuOpen",void 0),e([ge()],lo.prototype,"_floorMenuOpen",void 0),e([ge()],lo.prototype,"_canvasMode",void 0),e([ge()],lo.prototype,"_renamingFloorId",void 0),e([ge()],lo.prototype,"_renameValue",void 0),customElements.get("fpb-toolbar")||customElements.define("fpb-toolbar",lo);class co extends le{constructor(){super(...arguments),this.open=!1,this._mode="export",this._exportSelection=new Set,this._importEntries=[],this._importData=[],this._importing=!1,this._exporting=!1,this._error=null}static{this.styles=r`
    :host {
      display: none;
    }
